...
data = [
    ...
    },
    {
        "tag": "emotion",
        "patterns": [
            "I'm sad", "I feel lonely", "I am feeling down",
            "I'm very happy", "I'm feeling excited", "I am angry",
            "I'm frustrated", "I'm feeling depressed", "I'm nervous",
            "I feel great", "I'm so thrilled", "I'm scared",
            "I'm feeling loved", "I'm bored", "I'm exhausted",
            "I'm feeling hopeless", "I'm stressed", "I'm anxious"
        ],
        "responses": [
            "I'm here for you. Want to talk about it? 😔",
            "That's great to hear! 😊",
            "I hope things get better soon!",
            "I'm glad you're feeling good! What's making you happy?",
            "Take deep breaths. I'm here if you want to share.",
            "Remember, it's okay to feel this way. You can share with me.",
            "Feeling down is natural. Talking can help. Want to chat?",
            "That's exciting! Tell me more!",
            "You are doing great. Keep going!",
            "It's okay to take a break. Take care of yourself."
        ]
    },
    ...
    },
    {
        "tag": "technology",
        "patterns": [
            "What's new in tech?", "Tell me about new technologies", 
            "Latest tech news", "What's trending in technology?", 
            "Give me a tech update", "Any new innovations?", 
            "Tell me about the latest gadgets", "Tech news", "technology", "latest technology trends"
        ],
        "responses": [
            "Technology is advancing rapidly! Are you interested in AI, robotics, or something else?",
            "The latest trend is AI and machine learning advancements!",
            "Smart devices are evolving faster than ever!",
            "Blockchain and cryptocurrencies are still hot topics in tech!",
            "Have you heard about the latest in quantum computing?"
        ]
    },
    ...
    },  {"tag": "how_are_you", "patterns": ["How are you", "How's it going", "How do you do"], "responses": ["I'm just a bot, but I'm doing great! How about you?", "I'm here to assist you!"]},
    {
        "tag": "timeless_relics",
        "patterns": [
...
def train_model(patterns, tags):
    cleaned_patterns = [" ".join(word_tokenize(pattern.lower())) for pattern in patterns]
    vectorizer = TfidfVectorizer()
    X_train_tfidf = vectorizer.fit_transform(cleaned_patterns)
    classifier = LogisticRegression()
    classifier.fit(X_train_tfidf, tags)
    return vectorizer, classifier, X_train_tfidf

# Initialize and train the model
patterns, tags, responses = initialize_model(data)
vectorizer, classifier, X_train_tfidf = train_model(patterns, tags)
...
def chatbot_response(user_input):
    cleaned_input = " ".join(word_tokenize(user_input.lower()))
    ...
    if confidence < 0.2:
        best_match = find_best_match(cleaned_input)
        if best_match:
...
def main():
    ...
    for user_msg, bot_resp in st.session_state['history']:
